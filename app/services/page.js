			...
			<main>
				...
				<div className="flex flex-col items-center mt-24 w-full sm:max-w-[1280px] mx-auto gap-10 p-2 sm:p-10">
					...
					<div className="w-full flex lg:flex-row flex-col gap-10 ">
						<div className="lg:w-1/2 border border-[#292929] h-[500px] rounded-2xl my-cardBG flex flex-col justify-center items-center gap-10">
					...
					<div className="w-full lg:flex-row flex-col flex gap-5">
						<div className="lg:w-[22%] flex-wrap  flex flex-row  gap-2 lg:flex-col p-5 lg:justify-start justify-center lg:items-stretch items-center">
							...
							>
								...
								<span className="text-xs lg:text-base ">Web Development</span>
							</button>
							...
							>
								<div className="flex flex-col gap-3">
									...
									<p className="text-[#8C8C8C] text-sm">
										...
										our web design process involves a careful blend of
										creativity, user experience (UX) design, and cutting-edge
										technologies. We take the time to understand your business
										goals, target market, and unique selling points to create a
										website that not only looks great but also drives results.
									</p>
								</div>
								...
								<div className="w-full sm:p-8 p-2 border border-[#1F1F1F] mt-10 rounded-xl flex-col  flex  gap-8">
									<div className="px-4 flex flex-col gap-4">
										...
										<p className="text-sm text-[#808080]">
											...
											needs and branding. Here s an overview of our design
											process
										</p>
									</div>
									<div className="w-full h-full flex flex-col gap-10">
								...
								<div className="w-full px-2  sm:py-12 py-8  border border-[#1F1F1F] mt-10 rounded-xl flex-col  flex gap-8 relative">
									<div className="px-4 flex flex-col gap-4">
										...
										<p className="text-sm text-[#808080]">
											Check out some of our most recent Web Design projects in
											the table below
										</p>
									</div>
				...
				<div className="flex flex-col items-center mt-24 w-full sm:max-w-[1280px] mx-auto gap-10 relative p-2 sm:p-10">
					...
					<div className="flex flex-col items-center w-full min-h-[670px]">
						<div className="flex flex-col lg:flex-row gap-8 w-full h-full">
							<div className="lg:w-1/2 rounded-xl border border-[#1F1F1F] relative my-BG backdrop-filter backdrop-blur-lg bg-opacity-20 ">
