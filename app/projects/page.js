								...
								<div className="border mt-6 border-[#1F1F1F] rounded-xl lg:p-6 p-2">
									<div className="flex flex-col gap-4 p-4">
										...
										<p className="text-sm text-[#8C8C8C]">
											...
											latest trends, offers personalized recommendations, and
								...
								<ScrollAnimation variants={scaleUpVariants}>
									<div className=" h-full flex flex-col p-4 items-center gap-4">
										...
										<p className="text-sm font-thin text-center">
											...
											quote\ objectives and target audience.
										</p>
									</div>
								</ScrollAnimation>
							</div>
								...
								<div className="p-5 rounded-xl border-[#1F1F1F] flex flex-col gap-4 border my-BG backdrop-filter backdrop-blur-xl bg-opacity-20 relative">
									...
									<div className="flex flex-col justify-center gap-4 p-4  w-full min-h-[220px] mt-6 border rounded-xl border-[#1F1F1F]">
										...
										<p className="text-sm  text-[#8C8C8C]">
											...
											and implement advanced security measures to safeguard
											patient data. This ambitious undertaking will elevate the
											platform s capabilities and revolutionize healthcare
								...
								<div className="p-5 rounded-xl border-[#1F1F1F] flex flex-col gap-4 border my-BG backdrop-filter backdrop-blur-xl bg-opacity-20 relative">
									...
									<div className="flex flex-col justify-center gap-4 p-4  w-full min-h-[220px] mt-6 border rounded-xl border-[#1F1F1F]">
										...
										<p className="text-sm  text-[#8C8C8C]">
											...
											an AI-driven marketing automation platform. This
											cutting-edge solution will empower businesses to optimize
											their marketing efforts through data-driven insights,
											personalized customer interactions, and automated campaign
											management. The project promises to revolutionize the
											digital marketing landscape and drive exceptional results
								...
								<div className="p-5 rounded-xl border-[#1F1F1F] flex flex-col gap-4 border my-BG backdrop-filter backdrop-blur-xl bg-opacity-20 relative">
									...
									<div className="flex flex-col justify-center gap-4 p-4  w-full min-h-[220px] mt-6 border rounded-xl border-[#1F1F1F]">
										...
										<p className="text-sm  text-[#8C8C8C]">
											...
											products and environmentally friendly practices. The
											platform will empower consumers to make eco-conscious
											choices while supporting sustainable businesses. This
											project aligns with our commitment to creating digital
								...
								<div className="p-5 rounded-xl border-[#1F1F1F] flex flex-col gap-4 border my-BG backdrop-filter backdrop-blur-xl bg-opacity-20 relative">
									...
									<div className="flex flex-col justify-center gap-4 p-4  w-full min-h-[220px] mt-6 border rounded-xl border-[#1F1F1F]">
										...
										<p className="text-sm  text-[#8C8C8C]">
											...
											This project represents our dedication to using technology
