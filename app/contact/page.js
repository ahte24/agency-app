	...
	return (
		<>
			...
			<main>
				...
				<div className="flex flex-col items-center mt-24 w-full sm:max-w-[1280px] p-4 sm:p-10 mx-auto gap-10 team-BG min-h-[300px] justify-center border border-[#1F1F1F] rounded-xl ">
				...
				<div className="flex md:flex-row flex-col items-center p-8 mt-24 max-w-[1280px] mx-auto gap-10  min-h-[300px] ">
					<div className="flex flex-col gap-5 justify-between md:w-1/2 min-h-[250px] border border-[#1F1F1F] rounded-xl achievements-bg contactus-bg backdrop-filter backdrop-blur-xl bg-opacity-20 p-7">
				...
				<div className="flex flex-col items-center p-8 mt-24 max-w-[1280px] mx-auto gap-10  min-h-[300px] ">
					...
					<div className="w-full min-h-[250px] py-5 achievements-bg border border-[#1F1F1F] rounded-xl backdrop-filter backdrop-blur-xl bg-opacity-20 flex gap-8 flex-col items-center justify-center ">
