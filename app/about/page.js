		...
		<>
			<main>
				...
				<div className="flex flex-col items-center mt-24  sm:max-w-[1280px] mx-auto gap-10 p-2 sm:p-10">
					...
					<div className="w-full min-h-[750px] flex sm:flex-row lg:flex-col flex-col  gap-4 p-8">
						<div className="w-full lg:h-1/2 flex lg:flex-row flex-col items-center justify-center gap-8">
							<div className="lg:w-1/4 w-full flex flex-col justify-center items-center gap-4 h-full team-BG border border-[#1F1F1F] rounded-xl">
								...
								<div className="text-sm font-light border border-[#1F1F1F] px-3 py-2 rounded-full relative  bg-gradient-to-r from-[#424242] to-transparent">
									<span className=" text-xs">Co-Founder & CEO</span>
								</div>
								<svg
									width="250"
									height="2"
						...
						<div className="w-full lg:h-1/2 flex lg:flex-row flex-col items-center justify-center gap-8">
							<div className="lg:w-1/4 w-full flex flex-col justify-center items-center gap-4 h-full team-BG border border-[#1F1F1F] rounded-xl">
								<div className="w-24 flex justify-center items-center h-24 Dp-bg mt-4">
									<div className=" w-14 h-14 rounded-full overflow-hidden">
										<Image
											width={2000}
											height={2000}
								...
								<span className="font-semibold">Jessica Lee</span>
								<div className="text-sm font-light border border-[#1F1F1F] px-3 py-2 rounded-full relative  bg-gradient-to-r from-[#424242] to-transparent">
							...
							<div className="lg:w-1/4 w-full flex flex-col justify-center items-center gap-4 h-full team-BG border border-[#1F1F1F] rounded-xl">
								...
								<span className="font-semibold">Robert Johnson</span>
								<div className="text-sm font-light border border-[#1F1F1F] px-3 py-2 rounded-full relative  bg-gradient-to-r from-[#424242] to-transparent">
									<span className=" text-xs">Lead Mobile App Developer</span>
								</div>
								<svg
									width="250"
									height="2"
							...
							<div className="lg:w-1/4 w-full flex flex-col justify-center items-center gap-4 h-full team-BG border border-[#1F1F1F] rounded-xl">
								...
								<span className="font-semibold">Emma Taylor</span>
								<div className="text-sm font-light border border-[#1F1F1F] px-3 py-2 rounded-full relative  bg-gradient-to-r from-[#424242] to-transparent">
									<span className=" text-xs">Digital Marketer</span>
								</div>
								<svg
									width="250"
									height="2"
							...
							<div className="lg:w-1/4 w-full flex flex-col justify-center items-center gap-4 h-full team-BG border border-[#1F1F1F] rounded-xl">
								...
								<div className="text-sm font-light border border-[#1F1F1F] px-3 py-2 rounded-full relative  bg-gradient-to-r from-[#424242] to-transparent">
									<span className=" text-xs">Content Specialist</span>
								</div>
								<svg
									width="250"
									height="2"
				...
				<div className="flex flex-col items-center mt-24  w-full sm:max-w-[1280px] p-2 sm:p-10 mx-auto gap-10">
					...
					<div className="mt-6 w-full ">
						<div className="w-[100%] h-full flex flex-col gap-8 p-2 mx-auto relative">
							...
							<div className="pt-10 sm:pl-6 w-full min-h-[250px] border p-2 rounded-xl border-[#1F1F1F] sm:flex-row flex-col flex gap-5 ">
								<h1 className="text-5xl sm:text-6xl font-semibold text-[#ffffff]">001</h1>
								<div className="w-full lg:px-4 flex flex-col gap-4">
									<div className="w-full h-[40px] flex justify-between items-center">
										<h3 className="sm:text-base text-sm">Foundation of DigitX</h3>
							...
							<div className="pt-10 sm:pl-6 w-full min-h-[250px] border p-2 rounded-xl border-[#1F1F1F] sm:flex-row flex-col flex gap-5 ">
								<h1 className="text-5xl sm:text-6xl font-semibold text-[#ffffff]">002</h1>
								<div className="w-full lg:px-4 flex flex-col gap-4">
									<div className="w-full h-[40px] flex justify-between items-center">
										<h3 className="sm:text-base text-sm">100 Successful Projects</h3>
										<div className="px-4 py-2 rounded-full border-[#1F1F1F] border flex items-center gap-2">
											<svg
												width="20"
												height="20"
							...
							<div className="pt-10 sm:pl-6 w-full min-h-[250px] border p-2 rounded-xl border-[#1F1F1F] sm:flex-row flex-col flex gap-5 ">
								<h1 className="text-5xl sm:text-6xl font-semibold text-[#ffffff]">003</h1>
								<div className="w-full lg:px-4 flex flex-col gap-4">
									<div className="w-full h-[40px] flex justify-between items-center">
										<h3 className="sm:text-base text-sm">Expansion to International Markets</h3>
										<div className="px-4 py-2 rounded-full border-[#1F1F1F] border flex items-center gap-2">
											<svg
												width="20"
												height="20"
							...
							<div className="pt-10 sm:pl-6 w-full min-h-[250px] border p-2 rounded-xl border-[#1F1F1F] sm:flex-row flex-col flex gap-5 ">
								<h1 className="text-5xl sm:text-6xl font-semibold text-[#ffffff]">004</h1>
								<div className="w-full lg:px-4 flex flex-col gap-4">
									<div className="w-full h-[40px] flex justify-between items-center">
										<h3 className="sm:text-base text-sm">DigitX Innovation Lab Inauguration</h3>
										<div className="px-4 py-2 rounded-full border-[#1F1F1F] border flex items-center gap-2">
											<svg
												width="20"
												height="20"
									...
									<div className="h-full gap-4 rounded-xl border-[#1F1F1F] border p-5 flex flex-col justify-center achievements-bg">
										...
										<p className="text-sm text-[#8C8C8C]">
											...
											DigitX Innovation Lab. This state-of-the-art facility
							...
							<div className="pt-10 sm:pl-6 w-full min-h-[250px] border p-2 rounded-xl border-[#1F1F1F] sm:flex-row flex-col flex gap-5 ">
								<h1 className="text-5xl sm:text-6xl font-semibold text-[#ffffff]">005</h1>
								<div className="w-full lg:px-4 flex flex-col gap-4">
									<div className="w-full h-[40px] flex justify-between items-center">
										<h3 className="sm:text-base text-sm">500 Satisfied Clients</h3>
										<div className="px-4 py-2 rounded-full border-[#1F1F1F] border flex items-center gap-2">
											<svg
												width="20"
												height="20"
				...
				<div className="flex flex-col items-center mt-24  w-full sm:max-w-[1280px] p-2 sm:p-10 mx-auto gap-10">
					...
					<div className="flex flex-col gap-10">
						<div className="w-full md:flex-row flex-col flex gap-10 ">
							<div className="md:w-1/2 border border-[#292929] min-h-[500px] rounded-2xl my-cardBG flex flex-col justify-center items-center gap-4 p-4">
