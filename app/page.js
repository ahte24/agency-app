								...
								<ScrollAnimation variants={scaleUpVariants}>
									<div className="flex flex-col items-center gap-5">
										...
										<div className="flex flex-col items-center gap-3">
											...
											<p className="text-sm text-center w-[90%] text-[#8C8C8C]">
												In today s mobile-centric world, we prioritize
												mobile-first design to ensure your website.
											</p>
										</div>
										<Link
											href="/#"
									...
									<div className="flex flex-col items-center gap-5">
										...
										<div className="flex flex-col items-center gap-3">
											...
											<p className="text-sm w-[90%]  text-center text-[#8C8C8C]">
												Our data-driven marketing strategies allow us to target
								...
								<ScrollAnimation variants={scaleUpVariants}>
									<div className="flex flex-col items-center gap-5">
										...
										<div className="flex flex-col items-center gap-3">
											...
											<p className="text-sm w-[90%] text-center text-[#8C8C8C]">
												(SEO) Mastery Boost your online visibility with our
								...
								<div className="border border-[#292929] p-4 min-h-[600px] rounded-2xl my-cardBG flex flex-col justify-center items-center lg:gap-10 gap-4">
									...
									<div className="flex flex-col justify-center items-center gap-4 md:w-[80%]">
										...
										<p className="text-sm text-center text-[#8C8C8C]">
											...
											DigitX, our web development services empower you to stand
											out in the crowded online landscape. We create responsive
											and dynamic websites tailored to your unique needs,
											ensuring seamless user experiences across all devices.
											From e-commerce platforms to interactive web applications,
											our expert developers bring your vision to life, making
											your online journey a resounding success.
										</p>
									</div>
									<Link
								...
								<div className="border border-[#292929] p-4 min-h-[600px] rounded-2xl my-cardBG flex flex-col justify-center items-center lg:gap-10 gap-4">
									...
									<div className="flex flex-col justify-center items-center gap-4 md:w-[80%]">
										...
										<p className="text-sm text-center text-[#8C8C8C]">
											...
											mobile app development services enable you to harness this
											mobility to your advantage. We design and build intuitive
											and high-performance mobile applications that captivate
											your audience and boost engagement. Whether it s iOS,
											Android, or cross-platform development, we ensure that
											your app delivers a seamless experience, leaving a lasting
								...
								<div className="flex flex-col justify-center items-center min-h-[600px] lg:gap-10 gap-4  border border-[#292929] p-4 rounded-2xl my-cardBG">
									...
									<div className="flex flex-col justify-center items-center gap-4 md:w-[80%]">
										...
										<p className="text-sm text-center text-[#8C8C8C]">
											...
											reflection of your brand s identity and values. DigitX s
											web design services focus on creating visually striking
											and user-friendly interfaces that leave a lasting impact.
											Our creative team blends aesthetics with functionality,
											delivering a captivating user experience that keeps
											visitors coming back for more. Let us transform your
											online presence into an immersive journey that showcases
											your brand s true essence.
										</p>
									</div>
									<Link
										className="flex items-center gap-2 py-2 px-4 text-sm border bg-[#1a1a1a] border-[#262626] rounded-full"
								...
								<div className="flex flex-col justify-center items-center min-h-[600px] lg:gap-10 gap-4 border border-[#292929] p-4 rounded-2xl my-cardBG ">
									...
									<div className="flex flex-col justify-center items-center gap-4 md:w-[80%]">
										...
										<p className="text-sm text-center text-[#8C8C8C]">
											...
											marketing services help you rise above the noise and
											connect with your target audience effectively. From search
											engine optimization (SEO) to social media marketing and
											pay-per-click (PPC) campaigns, our data-driven strategies
											ensure that your message reaches the right people at the
											right time.
										</p>
									</div>
									<Link
								...
								<div className="min-h-[350px] my-clientCardBG gap-10 flex flex-col items-center justify-center border border-[#292929] rounded-2xl">
									...
									<div className="w-3/4 h-1/3 flex flex-col items-center justify-center gap-3">
										...
										<p className="text-sm text-[#8C8C8C] text-center">
											...
											Innovations, helping them revolutionize the way people
