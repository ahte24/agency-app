										...
										<div className="flex flex-col items-center gap-5">
											...
											<div className="flex flex-col items-center gap-3">
												...
												<p className="text-sm w-[90%]  text-center text-[#8C8C8C]">
													Our data-driven marketing strategies allow us to
									...
									<div className="border border-[#292929] p-4 min-h-[600px] rounded-2xl my-cardBG flex flex-col justify-center items-center lg:gap-10 gap-4">
										...
										<div className="flex flex-col justify-center items-center gap-4 md:w-[80%]">
											...
											<p className="text-sm text-center text-[#8C8C8C]">
												...
												DigitX, our web development services empower you to
									...
									<div className="flex flex-col justify-center items-center min-h-[600px] lg:gap-10 gap-4  border border-[#292929] p-4 rounded-2xl my-cardBG">
										...
										<div className="flex flex-col justify-center items-center gap-4 md:w-[80%]">
											...
											<p className="text-sm text-center text-[#8C8C8C]">
												...
												and user-friendly interfaces that leave a lasting
												impact. Our creative team blends aesthetics with
												functionality, delivering a captivating user experience
												that keeps visitors coming back for more. Let us
												transform your online presence into an immersive journey
												that showcases your brand s true essence.
											</p>
										</div>
										<Link
											className="flex items-center gap-2 py-2 px-4 text-sm border bg-[#1a1a1a] border-[#262626] rounded-full"
								...
								<ScrollAnimation variants={scaleUpVariants}>
									<div className="flex flex-col justify-center items-center min-h-[600px] lg:gap-10 gap-4 border border-[#292929] p-4 rounded-2xl my-cardBG ">
										...
										<div className="flex flex-col justify-center items-center gap-4 md:w-[80%]">
											...
											<p className="text-sm text-center text-[#8C8C8C]">
												Drive Your Business Forward In the vast digital
												landscape, standing out from the competition is crucial.
												Our digital marketing services help you rise above the
												noise and connect with your target audience effectively.
												From search engine optimization (SEO) to social media
												marketing and pay-per-click (PPC) campaigns, our
												data-driven strategies ensure that your message reaches
									...
									<div className="min-h-[350px] my-clientCardBG gap-10 flex flex-col items-center justify-center border border-[#292929] rounded-2xl">
										...
										<div className="w-3/4 h-1/3 flex flex-col items-center justify-center gap-3">
											...
											<p className="text-sm text-[#8C8C8C] text-center">
												DigitX developed a user-centric mobile app for
